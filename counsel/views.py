...
def counsel(request):  # this section for my appointment
    ...
    if "counsel" == group_name:
        ...
        return render(request, 'counsel.html', appointments)
    else:
...
def counsel_appointment_list(request):
    ...
    if "counsel" == group_name:
        ...
        return render(request, 'counsel_create_appointment.html', appointments)
    else:
        return redirect('http://127.0.0.1:8000/')
...
def appointment_delete(request, id):
    ...
    if "counsel" == group_name:
        ...
        return redirect('http://127.0.0.1:8000/counsel/create_appointment/')
    else:
        return redirect('http://127.0.0.1:8000/')
...
def counsel_appointment_update(request, id):
    ...
    if "counsel" == group_name:
        ...
        single_appointment = single_appointment = Appointment.objects.get(id=id)
        ...
        return render(request, 'counsel_appointment_update.html', appointments)
    else:
        return redirect('http://127.0.0.1:8000/')
